"""Prompt set schema for Weaviate."""
import os
import json
...
class PromptSetSchema:
    """Schema for prompt sets in Weaviate."""
    
    def __init__(self, collection_name="PromptSet", weaviate_client=None):
    ...
    def create_collection(self,
        ...
        self.weaviate.create_collection(
            ...
            description="Prompt set data including prompts, templates and configurations",
            ...
            properties=[
                ...
                wc.Property(
                    ...
                    description="List of prompts in the set",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=False,
                    tokenization=wc.Tokenization.WORD
                ...
                wc.Property(
                    name="config",
                    data_type=wc.DataType.TEXT,
                    description="Prompt set configuration",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
                ...
                wc.Property(
                    name="version",
                    data_type=wc.DataType.TEXT,
                    description="Prompt set version",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.FIELD
                ...
                wc.Property(
                    name="metadata",
                    data_type=wc.DataType.TEXT,
                    description="Additional prompt set metadata",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
                ...
                wc.Property(
                    name="tags",
                    data_type=wc.DataType.TEXT,
                    description="Tags for categorizing the prompt set",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
    ...
    def get_properties(self):
        ...
        prop = ["prompt_set_id", "name", "prompts", "templates", "variables",
                "config", "version", "created_at", "updated_at", "metadata",
                "tags", "description"]
        bm25prop = ["name", "prompts", "templates", "metadata", "tags"]
        mandatory_prop = ["prompt_set_id", "name", "prompts", "templates"]
