...
class LLMMetricsSchema:
    ...
    def __init__(self, collection_name="LLMMetrics", weaviate_client=None):
    ...
    def create_collection(self,
        ...
        self.weaviate.create_collection(
            ...
            description="Metrics and performance data for Language Model operations",
            ...
            properties=[
                ...
                wc.Property(
                    name="tags",
                    data_type=wc.DataType.TEXT,
                    description="Tags for categorizing metrics",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
    ...
    def get_properties(self):
        ...
        prop = ["user_id", "provider", "model", "total_requests", "successful_requests",
                "failed_requests", "average_latency", "total_tokens", "prompt_tokens",
                "completion_tokens", "total_cost", "metadata", "tags", "description"]
        bm25prop = ["provider", "model", "metadata", "tags"]
        mandatory_prop = ["user_id", "provider", "model"]
