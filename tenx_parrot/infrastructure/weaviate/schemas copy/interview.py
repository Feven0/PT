...
class InterviewSchema:
    ...
    def __init__(self, collection_name="Interview", weaviate_client=None):
    ...
    def create_collection(self,
        ...
        self.weaviate.create_collection(
            ...
            description="Interview session data including questions, answers and analysis",
            ...
            properties=[
                ...
                wc.Property(
                    name="answers",
                    data_type=wc.DataType.TEXT_ARRAY,
                    description="List of candidate answers",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=False,
                    tokenization=wc.Tokenization.WORD
                ...
                wc.Property(
                    name="evaluation",
                    data_type=wc.DataType.TEXT,
                    description="Interview evaluation and scoring",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=False,
                    tokenization=wc.Tokenization.WORD
                ...
                wc.Property(
                    name="tags",
                    data_type=wc.DataType.TEXT,
                    description="Tags for categorizing the interview",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
    ...
    def get_properties(self):
        ...
        prop = ["interview_id", "user_id", "candidate_id", "questions", "answers",
                "start_time", "end_time", "evaluation", "feedback", "metadata",
                "tags", "description"]
        bm25prop = ["questions", "answers", "evaluation", "feedback", "tags"]
        mandatory_prop = ["interview_id", "user_id", "candidate_id", "questions", "answers"]
