...
class AnalysisSchema:
    ...
    def __init__(self, collection_name="Analysis", weaviate_client=None):
    ...
    def create_collection(self,
        ...
        self.weaviate.create_collection(
            ...
            description="Analysis of chat and interview sessions including topics, sentiment, and insights",
            ...
            properties=[
                ...
                wc.Property(
                    name="tags",
                    data_type=wc.DataType.TEXT,
                    description="Tags for categorizing analysis",
                    index_filterable=True,
                    index_searchable=True,
                    skip_vectorization=True,
                    tokenization=wc.Tokenization.WORD
    ...
    def get_properties(self):
        ...
        prop = ["session_id", "type", "topics", "sentiment", "insights", "summary",
                "recommendations", "metrics", "metadata", "tags", "description"]
        bm25prop = ["topics", "insights", "summary", "recommendations", "tags"]
        mandatory_prop = ["session_id", "type", "topics", "insights", "summary"]
