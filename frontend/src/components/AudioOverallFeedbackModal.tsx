...
import { Modal, Button, Tabs, Collapse, Progress } from 'antd';
...
const AudioOverallFeedbackModal: React.FC<Data> =({metricsData, evaluationData}) => {
        ...
        <div>
            <div className='' style={{cursor: 'pointer'}}>
                <div className=''>
                    ...
                    onClick={showModal}>
                        <Progress percent={metricsData?.overall_performance_score} />
                    </div>
                </div>
            </div>
...
export default AudioOverallFeedbackModal;