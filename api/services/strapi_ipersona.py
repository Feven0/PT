...
class IpersonaManager(LeapBaseClass):
    ...
    def create_session(self, message_data):
        ...
        mutation_query = """
            mutation CreateIPersonaSession($slug: String!, $attributes: JSON!, $metadata: JSON!, $status: String!, $job_profile_id: ID!, $user_profile_id: ID!) {
        ...
        variables = {
            ...
            "status": 'Incomplete',
            "user_profile_id": message_data.get("user_profile_id"),
