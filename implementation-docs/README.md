...
- **`SPECIFICATION.md`** (1,200+ lines) - Complete application specification
- **`COMPILE_GUIDE.md`** - AI agent instructions for code generation
- **`LINT_GUIDE.md`** - Spec optimization instructions
- **`METHODOLOGY.md`** - Complete methodology guide
- **`CREATION_METHODOLOGY.md`** - How this spec was created
- **`CODEBASE_REVIEW.md`** - Comprehensive review results
...
cat implementation-docs/SPECIFICATION.md

# Or open in your editor
code implementation-docs/SPECIFICATION.md
```
...
1. **Understand the System**
   ...
   less implementation-docs/SPECIFICATION.md
   ```

2. **Make Changes**
   - Edit `implementation-docs/SPECIFICATION.md` to describe desired changes
   - Use AI agent: `/load implementation-docs/COMPILE_GUIDE.md`
   - Test the changes
...
- **`SPECIFICATION.md`** - Complete specification (1,200+ lines)
- **`METHODOLOGY.md`** - Methodology guide
- **`CREATION_METHODOLOGY.md`** - How spec was created
- **`CODEBASE_REVIEW.md`** - Comprehensive review
...
1. **Read the spec**: `implementation-docs/SPECIFICATION.md` - comprehensive documentation
