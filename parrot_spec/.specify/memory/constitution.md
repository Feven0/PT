...
- **Primary STT**: Google Cloud Speech-to-Text (MUST be used for all real-time interviews)
- **Fallback STT** (priority order):
  1. **First Backup**: OpenAI Whisper API
  2. **Second Backup**: AssemblyAI
  3. **Tertiary Fallbacks**: Faster Whisper, Google Gemini (available "in case")
