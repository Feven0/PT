...
import { engagementStats } from "../../redux/slices/userStatsSlice";
...
export default function EngagementStats({ stats, source }: TStats) {
  ...
  return (
    <Col xs={24}  lg={source === 'trainee' ? 22 : 24}  xxl={source === 'trainee' ? 18 : 24}>
      <div className="br-4 p-8" style={{
        marginTop: source === "trainee" ? "1rem" : "0",
        display: "flex",
        justifyContent: source === "trainee" ? "center" : "flex-end",
        alignItems: "center",
      }}>
