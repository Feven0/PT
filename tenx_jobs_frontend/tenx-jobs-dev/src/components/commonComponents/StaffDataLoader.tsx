...
export default function StaffDataLoader() {
  ...
  return (
    <Row gutter={16} justify="center" style={{marginTop:"0.5rem", background:"#fff", marginLeft:"0rem", marginRight:"0rem", borderRadius:"0.5rem"}}>
