...
const Api = {
  ...
  analyse: data => axios.post('http://0.0.0.0:5900/analyse/',data),
  interview: data => axios.post('http://0.0.0.0:5900/interview/',data),
  ...
  analyseDoc: data => axios.post('http://0.0.0.0:5900/api/analyse_cv', data),
  fetchSession: data => axios.post('http://0.0.0.0:5900/wv/fetch_user_session', data),
  fetchSessionJob: data => axios.post('http://0.0.0.0:5900/wv/fetch_session_job', data),
  fetchEvaluationMetrics: data => axios.post('http://0.0.0.0:5900/wv/fetch_inter_metrics', data),
  saveEvaluationMetrics: data => axios.post('http://0.0.0.0:5900/wv/save_metrics_to_db', data),
