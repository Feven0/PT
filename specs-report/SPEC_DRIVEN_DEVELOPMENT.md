...
1. Write specifications in Markdown (in `main.md`)
...
### `compile.prompt.md`
Instructions for the AI coding agent to compile `main.md` into Python code.
...
Edit `main.md` to describe desired changes. For example:
...
2. Test new features
3. If something doesn't work, update `main.md` to clarify the requirements
...
2. **Regular linting**: Run lint.prompt.md periodically
...
The `main.md` file currently describes:
...
1. Read and understand `main.md` first
2. Make spec changes in `main.md`
3. Compile using `compile.prompt.md`
4. Test thoroughly
