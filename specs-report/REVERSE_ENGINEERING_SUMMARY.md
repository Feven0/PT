...
```
specs/
├── main.md (780+ lines)           # Master specification
├── compile.prompt.md              # AI compilation instructions
├── lint.prompt.md                 # Spec optimization prompts
...
**`main.md` now contains (1,200+ lines):**
